...
// 					strLog = "send file fail: " + pTask->pPic->strFileName + "\tErrCode(Http错误码): " + response.getReason() + "(" + strErrCode + ")" + "\tPath: " + pTask->pPic->strFilePath;
					ssLog << "send file fail: " << pTask->pPic->strFileName << "\tErrCode(Http错误码): " << response.getReason() << "(" << nCode << ")\tPath: " << pTask->pPic->strFilePath;
...
//					pTask->pPapers->nUpLoadFail++;
				...
				{
// 					std::string strErrCode = Poco::format("%d", (int)response.getStatus());
// 					strLog = "post papers result failed: " + pTask->pPapers->strPapersName + "\tErrCode(Http错误码): " + response.getReason() + "(" + strErrCode + ")" + "\tPath: " + pTask->pPapers->strPapersPath + "\nResult info: ..." /*+ pTask->strResult*/;
// 					g_Log.LogOutError(strLog);
					ssLog << "post papers result failed: " << pTask->pPapers->strPapersName << "\tErrCode(Http错误码): " << response.getReason() << "(" << nCode << ")\tPath: " << pTask->pPapers->strPapersPath;
					g_Log.LogOutError(ssLog.str());
					std::cout << ssLog.str() << std::endl;
				}
				else if (pTask->nTaskType == 3)
				{
// 					std::string strErrCode = Poco::format("%d", (int)response.getStatus());
// 					strLog = "post omr result failed: " + pTask->pPapers->strPapersName + "\tErrCode(Http错误码): " + response.getReason() + "(" + strErrCode + ")" + "\tName: " + pTask->pPapers->strPapersName + "\nResult info: ..." /*+ pTask->strResult*/;
// 					g_Log.LogOutError(strLog);
					ssLog << "post omr result failed: " << pTask->pPapers->strPapersName << "\tErrCode(Http错误码): " << response.getReason() << "(" << nCode << ")\tPath: " << pTask->pPapers->strPapersPath;
					g_Log.LogOutError(ssLog.str());
					std::cout << ssLog.str() << std::endl;
				}
				else if (pTask->nTaskType == 4)
				{
// 					std::string strErrCode = Poco::format("%d", (int)response.getStatus());
// 					strLog = "post zkzh result failed: " + pTask->pPapers->strPapersName + "\tErrCode(Http错误码): " + response.getReason() + "(" + strErrCode + ")" + "\tName: " + pTask->pPapers->strPapersName + "\nResult info: ..." /*+ pTask->strResult*/;
// 					g_Log.LogOutError(strLog);
					ssLog << "post zkzh result failed: " << pTask->pPapers->strPapersName << "\tErrCode(Http错误码): " << response.getReason() << "(" << nCode << ")\tPath: " << pTask->pPapers->strPapersPath;
					g_Log.LogOutError(ssLog.str());
					std::cout << ssLog.str() << std::endl;
				}
				else if (pTask->nTaskType == 5)
				{
// 					std::string strErrCode = Poco::format("%d", (int)response.getStatus());
// 					strLog = "post ElectOmr result failed: " + pTask->pPapers->strPapersName + "\tErrCode(Http错误码): " + response.getReason() + "(" + strErrCode + ")" + "\tName: " + pTask->pPapers->strPapersName + "\nResult info: ..." /*+ pTask->strResult*/;
// 					g_Log.LogOutError(strLog);
					ssLog << "post ElectOmr result failed: " << pTask->pPapers->strPapersName << "\tErrCode(Http错误码): " << response.getReason() << "(" << nCode << ")\tPath: " << pTask->pPapers->strPapersPath;
					g_Log.LogOutError(ssLog.str());
					std::cout << ssLog.str() << std::endl;
				}
				pTask->nSendFlag++;
