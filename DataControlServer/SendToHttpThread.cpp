...
// 					g_Log.LogOutError(strLog);
					ssLog << "post papers result failed: " << pTask->pPic->strFileName << "\tErrCode(Http错误码): " << response.getReason() << "(" << nCode << ")\tPath: " << pTask->pPic->strFilePath;
					g_Log.LogOutError(ssLog.str());
					std::cout << strLog << std::endl;
				}
				else if (pTask->nTaskType == 3)
...
// 					g_Log.LogOutError(strLog);
					ssLog << "post omr result failed: " << pTask->pPic->strFileName << "\tErrCode(Http错误码): " << response.getReason() << "(" << nCode << ")\tPath: " << pTask->pPic->strFilePath;
					g_Log.LogOutError(ssLog.str());
					std::cout << strLog << std::endl;
				}
				else if (pTask->nTaskType == 4)
...
// 					g_Log.LogOutError(strLog);
					ssLog << "post zkzh result failed: " << pTask->pPic->strFileName << "\tErrCode(Http错误码): " << response.getReason() << "(" << nCode << ")\tPath: " << pTask->pPic->strFilePath;
					g_Log.LogOutError(ssLog.str());
					std::cout << strLog << std::endl;
				}
				else if (pTask->nTaskType == 5)
...
// 					g_Log.LogOutError(strLog);
					ssLog << "post ElectOmr result failed: " << pTask->pPic->strFileName << "\tErrCode(Http错误码): " << response.getReason() << "(" << nCode << ")\tPath: " << pTask->pPic->strFilePath;
					g_Log.LogOutError(ssLog.str());
					std::cout << strLog << std::endl;
				}
				pTask->nSendFlag++;
