...
// 	ON_MESSAGE(WM_KILLFOCUS, OnKillFocus)
	...
	//ON_WM_PAINT()
//	ON_WM_PAINT()
//	ON_CONTROL_REFLECT(EN_SETFOCUS, &CIconEdit::OnEnSetfocus)
END_MESSAGE_MAP()
  ...
  ============================================================*/
{
	...
	if( !m_icon.m_hWnd )
	{
		...
		CRect iconRect( 3, 3, editRect.left, clientRect.Height()-2 );
  ...
  ============================================================*/
{
	...
	/*CFont cfont;
	cfont.CreatePointFont(editRect.Height(),"宋体");
	SetFont(&cfont,TRUE);*/
  ...
  ============================================================*/
{
	...
	if( m_icon )
	{
		...
		::DrawIconEx( dc.m_hDC, 0, 0, m_icon, width, height, 0, NULL, DI_NORMAL );
		/*rect.left-=width;
		SetRect(&rect);*/
	}
